export const currencies = {
    ...
    PEN: { name: 'Peruvian Nuevo Sol', country: 'Peru' },
    ...
    PYG: { name: 'Paraguayan Guarani', country: 'Paraguay' },
    QAR: { name: 'Qatari Rial', country: 'Qatar' },
    ...
    VEF: { name: 'Venezuelan Bolívar', country: 'Venezuela' },
    VND: { name: 'Vietnamese Đồng', country: 'Vietnam' },
    VUV: { name: 'Vanuatu Vatu', country: 'Vanuatu' },
    WST: { name: 'Samoan Tala', country: 'Samoa' },
    XAF: { name: 'CFA Franc', country: 'Central Africa (XAF)' },
    XAG: { name: 'Silver Ounce', country: 'Global' },
    XAU: { name: 'Gold Ounce', country: 'Global' },
    XCD: { name: 'East Caribbean Dollar', country: 'East Caribbean States' },
    XOF: { name: 'CFA Franc', country: 'West Africa (XOF)' },
    XPF: { name: 'CFP Franc', country: 'Pacific Islands' },
    YER: { name: 'Yemeni Rial', country: 'Yemen' },
    ZAR: { name: 'South African Rand', country: 'South Africa' },
    ZMK: { name: 'Zambian Kwacha', country: 'Zambia' },
